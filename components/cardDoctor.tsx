    ...
    <div className="h-36 p-4 m-4 ">
      <div className="rounded-sm flex flex-col text-white bg-sexygray justify-between p-5 overflow-x-auto">
        ...
        <div className="flex flex-row space-x-3">
          <span className="rounded font-semibold dark:bg-green-500 py-1 px-2">Enrolled on {new Date(props.on * 1000).toDateString()}</span>
          <span className="rounded font-semibold dark:bg-amber-500 py-1 px-2">Age {props.age}</span>
          <span className="rounded font-semibold dark:bg-purple-500 py-1 px-2">Doctor {props.doctor}</span>
